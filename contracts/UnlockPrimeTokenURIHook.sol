...
contract UnlockPrimeTokenURIHook {
    ...
    function tokenURI(
        ...
        string memory memberId = string(
            abi.encodePacked(
                '<text fill="#603DEB" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="20" font-weight="600" letter-spacing="0em"><tspan x="277" y="570.273">',
        ...
        string memory validDeadline = string(
            abi.encodePacked(
                '<text fill="#603DEB" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="20" font-weight="600" letter-spacing="0em"><tspan x="277" y="659.273">',
                months[month], //
                " ",
        ...
        string memory svg = string(
            abi.encodePacked(
                '<svg width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg"> <rect width="1024" height="1024" fill="#F2C65E" /> <g filter="url(#filter0_d_2018_2607)"> <g clip-path="url(#clip0_2018_2607)"> <path d="M237 54H811V126H237V54Z" fill="#F5F5F5" /> <path d="M488 90C488 87.7909 489.791 86 492 86H556C558.209 86 560 87.7909 560 90V90C560 92.2091 558.209 94 556 94H492C489.791 94 488 92.2091 488 90V90Z" fill="#F2C65E" /> <rect width="574" height="166" transform="translate(237 126)" fill="#F5F5F5" /> <text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="28" letter-spacing="0em"><tspan x="277" y="237.864">by Unlock Labs</tspan></text> <text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="12" letter-spacing="0em"><tspan x="277" y="203.864">&#10;</tspan></text> <text fill="url(#paint0_linear_2018_2607)" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="48" font-weight="800" letter-spacing="0em"><tspan x="277" y="210.455">UNLOCK PRIME</tspan></text> <rect width="574" height="598" transform="translate(237 292)" fill="white" /> <text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="51" font-weight="bold" letter-spacing="0em"><tspan x="277" y="389.545">My Unlock </tspan><tspan x="277" y="451.545">Prime Pass</tspan></text> <text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="24" font-weight="500" letter-spacing="0em"><tspan x="277" y="540.545">Member ID</tspan></text> <text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="18" font-weight="500" letter-spacing="0em"><tspan x="277" y="489.545">&#10;</tspan><tspan x="277" y="511.545">&#10;</tspan></text>',
                memberId,
                '<text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="24" font-weight="500" letter-spacing="0em"><tspan x="277" y="629.545">Valid Through</tspan></text><text fill="#211814" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="18" font-weight="500" letter-spacing="0em"><tspan x="277" y="600.545">&#10;</tspan></text>',
                validDeadline,
